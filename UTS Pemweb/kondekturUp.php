...
<body style="background-color: #D9B08c">
    ...
    <form action="" method="post">
        <ul>
            <li>
            <label for="id_kondektur$id_kondektur">id_kondektur :</label>
...
if (isset($_POST["submit"])){
    ...
    $id_kondektur = $_POST['id_kondektur$id_kondektur'];
    $nama = $_POST['nama$nama'];

    $ambildata = "UPDATE kondektur SET nama='$nama' WHERE id_kondektur='$id_kondektur'";
